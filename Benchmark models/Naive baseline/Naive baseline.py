...
# Output folder
RESULTS_DIR = "Benchmark models/Naive baseline/results"
...
# SAVE RESULTS
# ============================================================
daily_csv = os.path.join(RESULTS_DIR, "naive_daily_results.csv")
readable_txt = os.path.join(RESULTS_DIR, "naive_daily_results_readable.txt")
metrics_csv = os.path.join(RESULTS_DIR, "naive_metrics.csv")
...
# PRINT SUMMARY
# ============================================================
print("\nNaive baseline simulation complete!")
